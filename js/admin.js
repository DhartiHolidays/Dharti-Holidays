...
document.getElementById('extractItineraryBtn').addEventListener('click', async () => {
  ...
  try {
    ...
    if (result.error === 'not_configured') {
      ...
      statusEl.innerHTML = '<p style="color:var(--navy); font-size:13px; font-weight:700;">✓ Extracted successfully — review the branded itinerary below.</p>';
      renderItineraryDoc(result.itinerary);
    }
  } catch (err) {
    ...
    btn.disabled = false;
    btn.textContent = 'Generate Branded Itinerary';
  }
});
